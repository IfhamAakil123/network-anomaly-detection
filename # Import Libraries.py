...
# Create a larger synthetic dataset with 1000 samples
data = pd.DataFrame({
    'duration': np.random.randint(1, 100, size=1000),
    'protocol_type': np.random.choice(['tcp', 'udp', 'icmp'], size=1000),
    'service': np.random.choice(['http', 'ftp', 'smtp', 'dns'], size=1000),
    'src_bytes': np.random.randint(0, 5000, size=1000),
    'dst_bytes': np.random.randint(0, 5000, size=1000),
    'attack_type': np.random.choice(['normal', 'anomaly'], size=1000, p=[0.8, 0.2])
})
